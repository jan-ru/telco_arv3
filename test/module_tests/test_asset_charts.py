#!/usr/bin/env python3
"""
Test script for asset_charts module
...
def test_asset_charts_module():
    """Test the asset_charts module"""
    
    print(f"Testing asset_charts module...")
    ...
    try:
        ...
        print(f"Loading asset_charts module...")
        exec(open('report_modules/asset_charts.py').read())  
        print(f"✅ asset_charts module executed successfully")
        ...
        print(f"❌ Error in asset_charts module: {e}")
        print("Full traceback:")
        traceback.print_exc()
        return False

if __name__ == "__main__":
    success = test_asset_charts_module()
