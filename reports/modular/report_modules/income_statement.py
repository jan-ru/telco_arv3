"""
Telco B.V. Financial Reporting - Income Statement Module

Description:
    Generates and displays the income statement (winst-en-verliesrekening) with 
    professional formatting using Great Tables. Includes financial analysis and 
    commentary on revenue, costs, and profitability metrics.

Dependencies:
    - pandas: DataFrame manipulation
    - great_tables: Professional table formatting
    - Required from setup: income_df, current_year, previous_year, 
      format_currency_eur, get_safe_value

Output:
    - Formatted income statement table
    - Financial analysis text
    - Revenue and cost commentary
